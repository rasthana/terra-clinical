...
const EmbeddedContentConsumerTests = () => (
  <div>
    <ul>
      ...
      <li><Link to="/tests/embedded-content-consumer-tests/custom-event-consumer">EmbeddedContentConsumer - Custom events Consumer</Link></li>
      ...
      <li><Link to="/tests/embedded-content-consumer-tests/resize-consumer">EmbeddedContentConsumer - Resize Consumer</Link></li>
    </ul>
  </div>
);
